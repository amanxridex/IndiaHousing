        ...
        <FadeIn direction="up" delay={0.2}>
          <div className={styles.founderCard}>
            ...
            <div className={styles.founderContent}>
              <h3 className={styles.founderName}>Vikram Singh</h3>
              <div className={styles.founderRole}>Founder & Chairman</div>
              <p className={styles.founderBio}>
                With over three decades of visionary leadership in the real estate sector, Vikram Singh established IHPL with a mission to transform the urban landscape of India. His uncompromising commitment to quality and sustainable development has been the cornerstone of our success, making IHPL a trusted name in luxury housing and commercial spaces.
              </p>
            </div>
          </div>
        </FadeIn>
